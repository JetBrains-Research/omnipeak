...
import org.jetbrains.bio.omnipeak.fit.OmnipeakConstants.OMNIPEAK_HMM_PRIORS
import org.jetbrains.bio.omnipeak.fit.OmnipeakConstants.OMNIPEAK_HMM_TRANSITIONS
import org.jetbrains.bio.omnipeak.statistics.emission.NegBinEmissionScheme
import org.jetbrains.bio.omnipeak.statistics.util.NegBinUtil
import org.jetbrains.bio.omnipeak.statistics.util.NegBinUtil.guessByData
...
class NB2ZHMM(nbMeans: DoubleArray, nbFailures: DoubleArray) :
    FreeNBZHMM(nbMeans, nbFailures,
        priorProbabilities = OMNIPEAK_HMM_PRIORS,
        transitionProbabilities = F64Array.invoke(3, 3) { i, j -> OMNIPEAK_HMM_TRANSITIONS[i][j] }
    ) {
