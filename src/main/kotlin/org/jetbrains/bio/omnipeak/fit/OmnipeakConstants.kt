...
object OmnipeakConstants {
    ...
    // Minimal low-state mean threshold, guards excessive noise, especially in low-quality data, affects sensitivity
    const val OMNIPEAK_DEFAULT_HMM_LOW_THRESHOLD = 0.5
    ...
    val OMNIPEAK_CLIP_STEPS = doubleArrayOf(0.1, 0.2, 0.5, 1.0, 2.0, 5.0, 10.0)
