 ...
 *
 * See [OmnipeakCLAAnalyze] for peak calling procedure.
 * See [OmnipeakCLACompare] for differential peak calling.
 *
 * @author Oleg Shpynov
 * @since  14/09/15
 */
...
object OmnipeakCLA {
    internal val LOG = LoggerFactory.getLogger(OmnipeakCLA::class.java)
...
"""
    ...
    internal fun getOptionParser(): OptionParser = object : OptionParser() {
        init {
            ...
            acceptsAll(listOf("b", "bin"), "Bin size (default: $OMNIPEAK_DEFAULT_BIN)")
                .withRequiredArg()
            ...
            acceptsAll(
                ...
                .defaultsTo(OMNIPEAK_DEFAULT_MULTIPLE_TEST_CORRECTION.name)
            ...
            acceptsAll(
                ...
                .withRequiredArg()
                .ofType(Double::class.java)
                .defaultsTo(OMNIPEAK_DEFAULT_FDR)
    ...
    internal fun getBin(
        ...
        options.valueOf("bin") as Int?, fitInformation?.binSize, OMNIPEAK_DEFAULT_BIN,
        "bin size", "BIN", log
    )
    ...
    internal fun getFitThreshold(
        ...
        options.valueOf("threshold") as Double?, null, OMNIPEAK_DEFAULT_FIT_THRESHOLD,
    ...
    internal fun getFitMaxIteration(
        ...
        options.valueOf("iterations") as Int?, null, OMNIPEAK_DEFAULT_FIT_MAX_ITERATIONS,
    ...
    internal fun matchTreatmentsAndControls(
        ...
        return commandLineTreatmentPaths.zip(spreadControlPaths).map { (treatment, control) ->
            OmnipeakDataPaths(treatment, control)
        }
    }
